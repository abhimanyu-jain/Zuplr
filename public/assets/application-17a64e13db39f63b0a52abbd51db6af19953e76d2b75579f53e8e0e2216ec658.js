...
(function() {
  ...
  $(document).ready(function() {
    $('#leadform-submit-1').on('click', function(e) {
      return $.ajax({
        url: '/users',
        method: 'POST',
        data: {
  ...
  $(document).ready(function() {
    return $('#leadform-submit-1').on('click', function(e) {
      var regex_for_email, regex_for_phone;
      e.preventDefault();
      if ($('#form-name-1').val().length > 0 && $('#form-phone-1').val().length > 0) {
        regex_for_phone = /^([0|\+[0-9]{1,5})?([7-9][0-9]{9})$/;
        regex_for_email = /\S+@\S+\.\S+/;
        if (regex_for_phone.test($('#form-phone-1').val()) && regex_for_email.test($('#form-name-1').val())) {
          $.ajax({
            url: '/users',
            data: {
              'user[email]': $('#form-name-1').val(),
  ...
  $(document).ready(function() {
    return $('#leadform-submit-2').on('click', function(e) {
      var regex_for_email, regex_for_phone;
      e.preventDefault();
      if ($('#form-name-2').val().length > 0 && $('#form-phone-2').val().length > 0) {
        regex_for_phone = /^([0|\+[0-9]{1,5})?([7-9][0-9]{9})$/;
        regex_for_email = /\S+@\S+\.\S+/;
        if (regex_for_phone.test($('#form-phone-2').val()) && regex_for_email.test($('#form-name-2').val())) {
          $.ajax({
            url: '/users',
            data: {
  ...
  $(function() {
    return setupDateTimePicker($('body'));
  });
